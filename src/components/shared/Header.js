...
import AdSearchInput from 'components/ad/AdSearchInput';
...
*/
    ...
    return (
      <nav className='navbar navbar-dark navbar-expand-lg'>
        ...
        <Link className='navbar-brand' to='/ads'><img src={process.env.PUBLIC_URL + '/img/react-logo.svg'} alt=""></img>PinoySwehoppe
